...
start=$(date +%s.%N)
ffmpeg -hwaccel vaapi -vaapi_device /dev/dri/renderD128 -i $1 -r 30 -g 90 -s 1280x720 -aspect 16:9 -c:v vp8_vaapi -deadline $2 -row-mt 1 -b:v 2500k -threads $5 -tile-columns $4 -cpu-used $3 -minrate $6 -maxrate 3000k -bufsize 3000k -crf 30 -frame-parallel 1 $7.webm
